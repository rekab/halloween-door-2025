...
def generate_scary_image_gemini(screenshot_pil, config):
    ...
    try:
        ...
        prompts = [
            # Cat heads
            "Replace all the people's heads with cat heads.",

            # Zombie
            "This is a black and white doorbell camera image showing people at a front "
            "door. Add 2-3 creepy zombies standing directly behind the people, with their "
            "decayed hands resting on the shoulders of the people in the photo. "
            ""
            "The zombies should have: pale rotting skin, disheveled matted hair, tattered "
            "clothing, hollow dead eyes with a menacing stare, mouths slightly open showing "
            "decayed teeth. Their hands should be visible reaching forward from behind, "
            "with bony fingers and peeling skin, resting menacingly on the shoulders of "
            "the people in front of them. "
            ""
            "Position the zombies directly behind the people - close enough that their "
            "hands clearly rest on the people's shoulders. The zombies should tower slightly "
            "over the people, with their faces visible over the people's heads or beside them. "
            "They should be clearly visible and prominent, emerging from the darkness immediately "
            "behind where the people stand. "
            ""
            "Keep the people in the foreground COMPLETELY UNCHANGED - do not alter their "
            "appearance, positions, clothing, or lighting in any way. Only add the zombies "
            "behind them with hands on shoulders. Maintain the grainy black and white night "
            "vision camera quality.",

            # Grim Reaper
            "This is a black and white night vision doorbell camera image showing people "
            "at a front door. Add a single towering grim reaper standing directly behind "
            "the people, with one skeletal hand resting on a person's shoulder. "
            ""
            "The grim reaper should have: a tall, imposing presence (7-8 feet tall), "
            "flowing tattered black hooded cloak with deep shadows concealing most of the face "
            "except for hollow eye sockets that glow faintly, skeletal hands with long bony "
            "fingers emerging from the sleeves. One skeletal hand should be clearly visible "
            "resting menacingly on the shoulder of one of the people. The other hand can hold "
            "a large scythe with a curved blade, or also rest on another person's shoulder. "
            "The hood should be tilted slightly downward as if watching the people. "
            ""
            "Position the reaper directly behind the people - close enough that its skeletal "
            "hand clearly rests on a shoulder, towering over them. The figure should be "
            "clearly visible and prominent, with details like the skeletal hand on the shoulder, "
            "the hollow eyes under the hood, and the hooded silhouette clearly visible in the "
            "darkness immediately behind the people. "
            ""
            ...
            "behind them with hand on shoulder. ",

            # Ghost
            "This is a black and white night vision doorbell camera image showing people "
            "at a front door. Add a creepy female ghost figure standing directly behind "
            "the people, with her pale ghostly hands resting on their shoulders. "
            ""
            ...
            "thin skeletal arms reaching forward from behind with pale ghostly hands that "
            "rest menacingly on the shoulders of the people in front of her. Her head should "
            "be tilted at an unnatural angle, with one eye barely visible through the hair "
            "showing a hollow, dead stare. The figure should have a slight ethereal glow "
            "around the edges, creating an otherworldly presence. "
            ""
            "Position the ghost directly behind the people - close enough that her hands "
            "clearly rest on their shoulders. The figure should be prominent and clearly "
            "visible, with her face visible over or beside the people's heads, emerging from "
            "the darkness immediately behind where they stand. The pale dress, skin, and hands "
            "should contrast dramatically against the dark background, creating a chilling "
            "\"she's touching them\" effect. "
            ""
            "Keep the people in the foreground COMPLETELY UNCHANGED - do not alter their "
            ...
            # Demon
            "This is a black and white doorbell camera image showing people at a front "
            "door. Add a demonic figure standing directly behind the people, with its "
            "clawed hands resting menacingly on their shoulders. "
            ""
            "The demon should have: a dark twisted face with glowing eyes, prominent curved "
            "horns protruding from its head, sharp teeth visible in a sinister grin, dark "
            "leathery or scaly skin texture, long clawed fingers that are clearly visible "
            "resting on the shoulders of the people in front. The demon should have an "
            "imposing, otherworldly presence that appears both corporeal and supernatural. "
            ""
            "Position the demon directly behind the people - close enough that its clawed "
            "hands clearly rest on their shoulders. The figure should be prominent and "
            "clearly visible, with its face visible over or beside the people's heads, and "
            "the horns and glowing eyes standing out against the darkness immediately behind "
            "where the people stand. "
            ""
            "Keep the people in the foreground COMPLETELY UNCHANGED - do not alter their "
            "appearance, positions, clothing, or lighting in any way. Only add the demon "
            "behind them with clawed hands on shoulders. Maintain the black and white night "
            "vision camera quality.",
        ]
